//Fri Oct 11 2024 15:08:27 GMT+0000 (Coordinated Universal Time)
//Base:https://github.com/echo094/decode-js
//Modify:https://github.com/smallfawn/decode_action
const _0x454ec0 = _0x427c74("永辉生活");
const _0x408278 = require("fs");
const _0xbc0ee4 = require("got");
const {
  CookieJar: _0x3e25a4
} = require("tough-cookie");
const _0x43b4a6 = "yhsh";
const _0x4031d7 = _0x43b4a6 + "Cookie.txt";
const _0x5a1d0b = 20000;
const _0x2ca80d = 3;
const _0x14be7e = 1.01;
const _0x3a423f = "yhsh";
const _0x13f210 = "https://leafxcy.coding.net/api/user/leafxcy/project/validcode/shared-depot/validCode/git/blob/master/code.json";
const _0x1e6035 = "https://leafxcy.coding.net/api/user/leafxcy/project/validcode/shared-depot/validCode/git/blob/master/" + _0x3a423f + ".json";
const _0x22a328 = "Mozilla/5.0 (iPhone; CPU iPhone OS 16_1_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.49(0x18003127) NetType/WIFI Language/zh_CN miniProgram/wxc9cf7c95499ee604";
const _0x3814f0 = "10.4.5.3";
const _0x297eb2 = "9601";
const _0x5b0990 = _0x297eb2;
const _0x3bd5e2 = 2000;
const _0x3989bb = 5;
class _0x55ea0b {
  constructor() {
  ...
  get_prefix(_0x4166ea = {}) {
    var _0x411b32 = "";
    var _0x5caca2 = _0x454ec0.userCount.toString().length;
    if (this.index) {
  ...
  async request(_0x5adfb9) {
    ...
    const _0x576188 = ["TimeoutError"];
    let _0x54fbe8 = _0x454ec0.copy(_0x5adfb9);
    let _0x5892e3 = {};
    try {
      let _0x41dc1e = null;
      let _0x487db1 = 0;
      let _0x5ae7cb = _0x54fbe8.fn || _0x54fbe8.url;
      let _0x5c1049 = _0x54fbe8.valid_code || [200];
      let _0xe7e986 = _0x54fbe8.retry_code || [];
      if (_0x54fbe8.form) {
      ...
      while (_0x487db1 < _0x2ca80d) {
        ...
        try {
          ...
          let _0x4b6e22 = false;
          let _0x2ba956 = Date.now();
          let _0x438927 = _0x1acf6b(_0x54fbe8);
          let _0x329f0b = setTimeout(() => {
            _0x4b6e22 = true;
            _0x438927.cancel();
          }, _0x26051d);
          ...
          let _0x151e7e = _0x2e4856 - _0x2ba956;
          let _0x2c8400 = _0x41dc1e?.["statusCode"] || null;
      ...
      let _0x39b9b1 = _0x454ec0.get(_0x54fbe8, "decode_json", true);
...
class _0x35e111 extends _0x55ea0b {
  ...
  async get_accessToken(_0x44f116 = {}) {
    ...
    try {
      ...
      let _0x4afae9 = _0x454ec0.get(_0x44fe16, "code", _0x4dccc0);
      if (_0x4afae9 == 0) {
        let {
  ...
  async getinfo(_0x3c37e6 = {}) {
    try {
      ...
      let _0x3d6a0c = _0x454ec0.get(_0x2f37d0, "code", _0x489688);
      if (_0x3d6a0c == 0) {
        let {
          mobile: _0x32f9c8,
          memberid: _0x4338c0,
  ...
  async signreward_detail(_0x15a6e1 = {}) {
    try {
      ...
      let _0x4b889e = _0x454ec0.get(_0x1d4db0, "code", _0x294401);
      if (_0x4b889e == 0) {
        let {
          signflag: _0x2c224a,
          missionid: _0x588166
  ...
  async signreward_sign(_0x8a6836, _0x1673fe = {}) {
    try {
      ...
      let _0x4ceae8 = _0x454ec0.get(_0x4d56c6, "code", _0x4dd145);
      if (_0x4ceae8 == 0) {
        let {
          credit = 0,
          couponvos: _0x2c723e
  ...
  async teamDetail(_0x629a6d = {}) {
    try {
      ...
      let _0x873253 = _0x454ec0.get(_0x4a4e26, "code", _0x24abbd);
      if (_0x873253 == 0) {
        let {
          hasTeam: _0xfa23dd,
          teamSize: _0x2f9c21,
  ...
  async createTeam(_0x1d4ffb = {}) {
    try {
      ...
      let _0x3a9825 = _0x454ec0.get(_0x42f020, "code", _0x16f7b6);
      if (_0x3a9825 == 0) {
        let {
          teamSize: _0x10d817,
  ...
  async joinTheParty(_0x4fe00d, _0x359bba = {}) {
    try {
      ...
      let _0xbb601a = _0x454ec0.get(_0x131869, "code", _0x2aa84d);
      if (_0xbb601a == 0) {
  ...
  async getcreditcouponpageinfo_v2(_0x4d1ee3 = {}) {
    try {
      ...
      let _0x1c5e8c = _0x454ec0.get(_0x568e34, "code", _0x53a888);
      if (_0x1c5e8c == 0) {
...
function _0x427c74(_0xb7969a) {
  return new class {
    ...
    padStr(_0x207b14, _0x4c5df8, _0x2a0033 = {}) {
      ...
      let _0xc9ab61 = _0x2a0033.mode || "l";
      let _0x125900 = String(_0x207b14);
      let _0x3e10d8 = _0x4c5df8 > _0x125900.length ? _0x4c5df8 - _0x125900.length : 0;
      let _0x38482b = "";
    ...
    str2json(_0x5dd8a9, _0x4dfef0 = false) {
      ...
      for (let _0x259052 of _0x5dd8a9.split("&")) {
        ...
        let _0x2201f0 = _0x259052.substr(_0x30854f + 1);
        if (_0x4dfef0) {
    ...
    async exitNow() {
      ...
      let _0x15d519 = (_0x12cc86 - this.startTime) / 1000;
      this.log("");
      const _0x5967f7 = {
        time: true
      };
    ...
    async wait_until(_0x509a30, _0x9acf04 = {}) {
      ...
      let _0x56db21 = _0x9acf04.interval || this.default_wait_interval;
      let _0x292a98 = _0x9acf04.limit || this.default_wait_limit;
      let _0x48bacf = _0x9acf04.ahead || this.default_wait_ahead;
      ...
      let _0x5e7e0d = this.time("hh:mm:ss.S", _0x2c9980);
      let _0xc66caa = Date.now();
