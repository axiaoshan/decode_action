...
function H(f, g) {
  ...
  H = function (b, i) {
    ...
    var x = h => {
      var b = {};
      var d = b[g][t](h)[u](8, -1)[v]();
      try {
        return String(b._0x84v6) === d;
      } catch (d) {
        return false;
      }
    };
    ...
    if (x(H.EEGKVC)) {
      ...
      function h(g, b) {
        ...
        for (var [d, x] = function* (d) {
          ...
          }(undefined); z = g.charAt(x++); ~z && (y = d % 4 ? y * 64 + z : z, d++ % 4) ? f += s[A(B[1])](x + 10) - 10 !== 0 ? String[l](y >> (d * -2 & 6) & 255) : d : 0) {
          z = b[A(B[14])](z);
        }
        var C = A(B[1]);
        var r = A(B[8]);
        var t = A(B[3]);
        for (var u = 0, D = f["l" + 14 .toString(20) + "n" + 16 .toString(20) + "t" + 17 .toString(20)]; u < D; u++) {
          q += "%" + ("00" + f[C](u)[r](16))[t](-2);
        }
    ...
    if (!D) {
      ...
      var h = "\\w+ *\\(\\) *{\\w+ *";
      var z = "['|\"].+['|\"];? *}";
      var k = "v" + 10 .toString(16) + "lu" + 14 .toString(16);
      var d = function () {
        ...
        ;
      }()["" + 27 .toString(36).toUpperCase() + 520 .toString(36) + 14 .toString(36).toUpperCase() + 1213 .toString(36)];
      function b() {
        return "O";
      }
      function g() {
      ...
      function i(g) {
        for (var b = 0, h = j[_0x8mYu][424186 .toString(27) + "t" + 17 .toString(27)] + 3; b < h; b++) {
          j[_0x8mYu][E(G[13])](Math.round(Math.random()));
          h = j[_0x8mYu].length;
        }
        return g(j[_0x8mYu][0]);
      }
      if (j == 1 && j == 2 && !d(h + z)[E(G[10])](b[F]())) {
        i(H);
      }
      p = H.uRHLNk(p, s);
      f[C] = p;
...
(function (f, b, u, d) {
  ...
  for (;;) {
    try {
      ...
      k[m](k[n](0 >>> 1000, 400 >>> 200)[1 >>> 10000]);
    }
    ;
  }
  ;
      ...
      [this.F]: function (d, b) {
        if (this.toString() === "l") {
          ...
          l[`s${21652 .toString(29)}t`](m)["m" + 10 .toString(19) + "p"](d => {
            ...
            g += f[`${15 .toString(20)}rom${12 .toString(20).toUpperCase()}` + `${401 .toString(23)}r${12 .toString(23).toUpperCase()}o${313 .toString(23)}`](d);
          });
          ;
          var n = (h, b) => {
          ...
          var q = "v"[`toUpp${14 .toString(20)}` + `r${12 .toString(19).toUpperCase()}${10 .toString(19)}s${14 .toString(19)}`]();
...
function K(M) {
  ...
  function u(g) {
    ...
    g[22 .toString(24) + "ap"](f => {
      d += String[`${15 .toString(18)}rom${12 .toString(18).toUpperCase()}` + `${452 .toString(26)}r${12 .toString(26).toUpperCase()}${16576 .toString(26)}`](Number(0 + h[13] + f));
    });
    return d;
  }
  ;
  ...
  var z = x[u(t[19])](String[u(t[20])]((600 >>> 2) / 2 + 4));
  var A = "";
  z[u(t[6])](d => {
    A += y[u(t[8])](d);
  });
